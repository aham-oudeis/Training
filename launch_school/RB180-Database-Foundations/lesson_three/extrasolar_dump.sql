...
--
-- Name: spectral_type_options; Type: TYPE; Schema: public; Owner: gagan
--

CREATE TYPE public.spectral_type_options AS ENUM (
    'O',
    'B',
    'A',
    'F',
...
ALTER TYPE public.spectral_type_options OWNER TO gagan;
...
CREATE TABLE public.stars (
    ...
    spectral_type public.spectral_type_options NOT NULL,
...
--
-- Name: planets unique_designation; Type: CONSTRAINT; Schema: public; Owner: gagan
--
